...
import AcoesTabelaItens from '@/components/produtos/AcoesTabelaItens.vue';
...
function onAdicionarItem(localItem: any) {
    ...
    localItem.quantidade = localItem.quantidade ?? 1;
            ...
            <div class="md:grid-cols 4 grid-cols-1">
                <div
                    ...
                    <Form @submit.prevent="submit">
                        ...
                        <div class="mb-4 grid grid-cols-1 gap-6 md:grid-cols-4">
                            <ButtonCriarAddItem :produto="produtosList" @adicionar-item="onAdicionarItem" />
                        </div>
                        ...
                        <Table v-if="itens?.length > 0">
                            ...
                            <TableBody>
                                <TableRow v-for="item in itens" :key="item.id_item">
                                    <TableCell>
                                        {{ getItemNome(item) }}
                                    </TableCell>
                                    <TableCell>
